...
// import { Days, Test } from "@/src/models";
...
//   const [properties1, setProperties] = useState(["weight"]);
...
//       const currentProps = await DataStore.query(Test);
//       currentProps.sort((a, b) => {
//         return a.index - b.index;
//       });
//       setCurrentProperties(currentProps);
...
// //       <div key={index}>
// //         {currentProperties[index].properties[index] != undefined &&
// //         <p>
// //       {(JSON.parse(currentProperties[index].properties)).property}
// //       </p>
// // }
// //       </div>
//  console.log((JSON.parse(currentProperties[0].properties))[properties1[0]])
//     // console.log(currentProperties[0].properties[currentProperties[0]]);
...
//               setProperties([...properties1, textInputs]);
//             }
//             setTextInput("");
//           }}
//         >
